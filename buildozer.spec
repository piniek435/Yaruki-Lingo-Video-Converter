...
requirements = python3==3.8.10,kivy==2.2.0,hostpython3==3.8.10,plyer,pyjnius==1.5.0,jnius,Cython==0.29.33
...
#android.ndk_path = /project/android-ndk-r25c
...
\home\piniek\.buildozer\android\platform\android-sdk\tools\bin
